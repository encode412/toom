...
const FourthSection = () => {
  return (
    <div className="md:pt-10 pb-32 px-10">
      <div className="md:text-center flex justify-center items-center md:text-6xl text-4xl font-medium pb-10 md:pb-20 text-[#111019]">
      ...
      <div className="md:flex items-center justify-center">
        ...
        <div className="pt-10 md:ml-20 md:w-1/3">
          <div className="flex gap-6">
            <div className="hidden bg-[#b2b3f1] w-14 h-14 rounded-full md:flex items-center justify-center">
            ...
            <div className="flex gap-6">
              ...
              <div className="md:w-96">
                ...
                <div className="md:text-xl text-[#6c6684] leading-8 md:leading-10 font-light pt-6">
                  ...
                  and emojis to your videoo. Transcripts and captions in 50+
