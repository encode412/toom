    ...
    <div className="md:py-40 bg-[#eff0ff]">
      <div className="flex flex-col justify-center space-y-4">
        ...
        <p className="text-xl md:text-3xl font-light md:text-center md:w-2/3 mx-auto px-10 md:px-0 text-[#3d2e7c]">
          Record better presentation, faster feedback, and smoother hand-offs,
          with Llum AI. So you can be more productive, wherever you work.
        </p>
        <div className="flex gap-4 md:justify-center px-10 py-4">
          <div className="flex">
            <div className="text-white px-6 justify-between text-md font-light rounded-[40px] border-4 border-indigo-400/90 md:py-4 bg-[#565add] transition-all duration-300 shadow-md hover:shadow-indigo-500 hover:scale-110">
              <div className="flex items-center justify-center">
                <div className="text-lg py-4 md:py-0">Get Llum AI</div>
              </div>
            </div>
          </div>
        </div>
