...
const FourthSection = () => {
  return (
    <div className="bg-[#111019]">
      ...
      <div className="px-10 space-y-10 md:space-y-0 md:flex md:pt-20 mx-auto justify-evenly">
        <div>
          ...
          <div className="text-[#bbb6c6] text-lg leading-8 w-96">
            Connect packets of institutional knowledge by making video messages searchable and discoverable
          </div>
        </div>
        <div>
          <div className="md:text-3xl pb-4 text-lg text-[#f1f0f3] font-medium">
