  ...
  return (
    <div className="md:py-20">
      <div className="md:text-center space-y-4 px-10">
        ...
        Move fast and stand out with a personalized sales experience powered by async video.
        </p>
        ...
        Why Sales teams use Loom
        </div>
        <div className="md:justify-center flex">
          <div className="flex sm:flex-col space-y-6 pb-20">
