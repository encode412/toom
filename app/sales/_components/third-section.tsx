          ...
          <div className="flex space-x-10">
            <div className="space-y-10">
              <div className="space-y-1 text-md">
                ...
                <div className="text-[#1f3575] text-xl font-light leading-8">
                  Keep everyone on track and in the loop using streamlined
                  communication that scales.
                </div>
              </div>
              <div className="space-y-1">
                <div className="text-[#1f3575] text-xl font-medium leading-normal">
                ...
                <div className="text-sm md:text-md text-[#1f3575] leading-6 md:leading-10 font-light">
                  ...
                  your screen, camera or both with Llum.
                </div>
              </div>
              <div className="space-y-1">
                <div className="text-[#1f3575] text-xl font-medium leading-normal">
              ...
              <div className="space-y-1">
                ...
                <div className="text-sm md:text-md text-[#1f3575] leading-6 md:leading-10 font-light">
                  ...
                  in Slack, Figma, Sketch, and anywhere else your team works.
                </div>
              </div>
            </div>
          </div>
