      ...
      <div className="md:w-5/6 md:mx-auto bg-[#ffedec] md:rounded-[80px] px-10 md:p-20 items-center justify-center py-10">
        <div className="md:flex">
          ...
          <div className="text-xl md:text-3xl text-[#92312a] leading-relaxed font-light justify-start items-start flex md:w-2/5 mx-auto">
            Offer feedback on a project using a quick video commentary or create
            a one-on-one session for personal attention and encouragement from
            anywhere
          </div>
        </div>
        <div className="my-10 border md:p-20 px-10 py-8 rounded-[80px] itmes-center justify-center flex bg-white space-x-6 md:space-x-10 shadow-xl">
          <div onClick={handleEmojiClick1}>
            <div className="cursor-pointer text-3xl md:text-6xl">👍</div>
          </div>
