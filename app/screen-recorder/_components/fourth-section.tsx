        ...
        <div className="flex flex-col text-center">
          <div>
            <div className="pt-16 pb-8 text-4xl md:text-7xl text-[#eff0ff]">
              More connections with Llum
            </div>
            <div className="text-xl font-light mt-4 leading-8 md:text-3xl text-[#d1d1f7] md:text-center mx-auto md:w-3/4">
              Bird is ideal for communicating every important message. Teams use
              Bird to share ideas, create stronger relationships, and lead
              creative discussions.
            </div>
          </div>
          <video
            className="mt-20 md:w-2/3 rounded-[40px] shadow-indigo-400 mx-auto shadow-2xl"
            autoPlay
            muted
            loop
          >
        ...
        <div className="md:flex items-center justify-center text-white md:space-x-20 pt-20 space-y-6">
          <div className="py-4">
            ...
            <div className="text-[#d1d1f7] text-sm font-light leading-6">
              Quickly share what the team needs to know in a way that respects
              everyone's schedule and makes it easy to work remote or async
