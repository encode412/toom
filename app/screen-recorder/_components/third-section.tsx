...
const ThirdSection = () => {
  return (
    <div>
      <div className="mx-auto text-center justify-center items-center md:text-6xl text-3xl font-medium py-14">
            ...
            <div className="pt-10 md:pt-20 px-10 md:ml-20 md:w-1/3">
              <div className="flex gap-6">
                <div>
                  ...
                  <div className="textxl text-[#3d2e7c] leading-10 font-light pt-6">
