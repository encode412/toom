      ...
      <Accordion className="pl-2 " type="single" collapsible>
        <AccordionItem className="my-6 border-b" value="item-1">
          ...
          <AccordionContent>
            ...
            >
              <div>
                <Settings className="h-6 w-6 mr-4 text-gray-400" />
              </div>
        ...
        <AccordionItem className="my-6 border-b" value="item-3">
          ...
          <AccordionContent>
            ...
            <Link href={"/"} className="flex pt-10" onClick={handleLinkClick}>
              <div>
                <Headphones className="h-6 w-6 mr-4 text-gray-400" />
              </div>
              <div>Support</div>
            </Link>
          </AccordionContent>
        ...
        <Link href={"/pricing"}>
          <div className="flex flex-1 items-center justify-between text-xl px-6 py-4 my-6 border-b">
            Pricing
            <div>
        ...
        <Link href={"/contact"}>
          <div className="flex flex-1 items-center justify-between text-xl px-6 py-4 my-6">
            Contact Sales
            <div>
              <ArrowRight className="h-6 w-6" />
            </div>
